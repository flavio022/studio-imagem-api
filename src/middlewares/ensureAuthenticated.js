...
exports.ensureAuthetnticated = void 0;
var jsonwebtoken_1 = require("jsonwebtoken");
var UserRepository_1 = require("../modules/user/repositories/implementations/UserRepository");
var AppError_1 = require("../errors/AppError");
function ensureAuthetnticated(request, response, next) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, _a, token, user_id, userRepository, user, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    user_id = jsonwebtoken_1.verify(token, "7ddd68e771c61f836eb6de453185c505").sub;
                ...
                case 3:
                    _b = _c.sent();
                    throw new AppError_1.AppError("Inválid token", 401);
