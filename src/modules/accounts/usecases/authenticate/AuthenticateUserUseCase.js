            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (!passwordMatch) {
                            throw new AppError_1.AppError("password incorrect!", 401);
                        }
                        if (!user.isActiveted) {
                            throw new AppError_1.AppError("This user is disable!", 401);
                        }
                        token = jsonwebtoken_1.sign({}, "7ddd68e771c61f836eb6de453185c505", {
                            subject: user.id,
                            expiresIn: "1d"
                        });
                        ;
