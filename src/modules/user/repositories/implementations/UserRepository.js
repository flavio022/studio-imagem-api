...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.enableUser = function (_a) {
    ...
    UserRepository.prototype.setAdmin = function (_a) {
    ...
    UserRepository.prototype.create = function (_a) {
        var name = _a.name, company = _a.company, address = _a.address, email = _a.email, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_b) {
                switch (_b.label) {
