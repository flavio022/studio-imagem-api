...
var CreateUserUseCase = /** @class */ (function () {
    ...
    CreateUserUseCase.prototype.execute = function (_a) {
        var name = _a.name, email = _a.email, company = _a.company, address = _a.address, password = _a.password;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.userRepository.create({ name: name, email: email, company: company, address: address, password: passwordHash })];
                    case 3:
                        _b.sent();
                        return [2 /*return*/];
                }
