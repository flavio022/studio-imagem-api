...
var ListUserController = /** @class */ (function () {
    ...
    ListUserController.prototype.handler = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var listUserUseCase, usersList;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listUserUseCase = tsyringe_1.container.resolve(ListUserUseCase_1.ListUserUseCase);
                        return [4 /*yield*/, listUserUseCase.execute()];
                    case 1:
                        usersList = _a.sent();
