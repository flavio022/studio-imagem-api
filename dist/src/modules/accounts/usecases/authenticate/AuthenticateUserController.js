...
var AuthenticateUserController = /** @class */ (function () {
    ...
    AuthenticateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, password, email, authenticateUseCase, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, password = _a.password, email = _a.email;
                        authenticateUseCase = tsyringe_1.container.resolve(AuthenticateUserUseCase_1.AuthenticateUserUseCase);
                        return [4 /*yield*/, authenticateUseCase.execute({
                                password: password,
                                email: email
                            })];
                    case 1:
