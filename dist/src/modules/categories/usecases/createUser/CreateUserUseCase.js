...
var IUserRepository_1 = require("../../repositories/IUserRepository");
...
var CreateUserUseCase = /** @class */ (function () {
    ...
    CreateUserUseCase.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var categoryAlreadyExists, passwordHash;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (categoryAlreadyExists) {
                            throw new AppError_1.AppError("User already exist!", 401);
                        }
                        return [4 /*yield*/, bcryptjs_1.hash(password, 8)];
                    case 2:
                        passwordHash = _b.sent();
                        return [4 /*yield*/, this.userRepository.create({ name: name, email: email, password: passwordHash })];
                    case 3:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    CreateUserUseCase = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof IUserRepository_1.IUserRepository !== "undefined" && IUserRepository_1.IUserRepository) === "function" ? _a : Object])
    ], CreateUserUseCase);
